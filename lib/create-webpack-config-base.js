    ...
    const config = {
      ...
      resolve: {
        alias: {
          ...
          '@mapbox/batfish/modules/route-to': path.join(
            __dirname,
            '../modules/route-to.js'
          ),
          '@mapbox/batfish/modules/prefix-url': path.join(
            __dirname,
            '../modules/prefix-url.js'
          ),
          '@mapbox/batfish/modules/with-location': path.join(
            __dirname,
            '../modules/with-location.js'
          )
        }
      },
      module: {
