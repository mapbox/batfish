...
const enhancePostcssError = require('./enhance-postcss-error');

const urlCache = new Map();

function handleCssError(error) {
  const typedError = wrapError(
    enhancePostcssError(error),
    errorTypes.CssCompilationError
  );
  throw typedError;
}
