 ...
 * @param {Object} options.siteData - Batfish config's data plus pages data.
...
function createPageModule(options) {
  ...
  const props = {
    frontMatter: _.omit(pageFrontMatter, ['siteData'])
  };

  if (pageFrontMatter && pageFrontMatter.siteData) {
    props.siteData = {};
