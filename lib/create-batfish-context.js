      ...
      return createPageModule(
        ...
        stringifiedRoutes.push(`{
            ...
            getPage: () => import(
              ...
              '${pageModuleFilePath}'
            ).catch(e => handleImportError('${pageData.filePath}', e)),
    ...
    return createDataModules(batfishConfig, siteData)
      ...
      .then(() => {
        ...
        const content = `
          ...
          function handleImportError(pageFilePath, error) {
            console.error('Error importing page: ' + pageFilePath + '\\n' + stripColor(error.stack.toString()));
          }
